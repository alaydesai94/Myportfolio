        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p >I am a Alay Desai currently living in Toronto,Canada. I work at CodeSmart as a Application Developer and
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I pursued my internship as IOS Developer at Connect to the core inc. and worked on  xcode, swift</p>
                </div>
                </div>
            </div>
